...
export default class FirstTextScene extends Phaser.Scene {
	constructor() {
		super({key: 'FirstTextScene'});
	}
    ...
    create()
    {
        ...
        this.scrollText(scriptText.first[0]);
        this.input.on('pointerup', function() {
            console.log(this.textCount)
            switch(this.textCount)
            {
                case 0:
                    this.scrollText(scriptText.first[1]);
                    break;
                case 1:
                    this.scrollText(scriptText.first[2]);
                    break;
                case 2:
                    this.scrollText(scriptText.first[3]);
                    break;
                case 3:
